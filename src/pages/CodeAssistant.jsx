      ...
      : [
          {
            ...
            role: "assistant",
            content:
              "Hello! Paste your code here and I'll help you explain, fix, or optimize it.",
          },
        ];
  });
    ...
    const fetchAIResponse = async () => {
      try {
        ...
        if (data.reply) {
          ...
          setCodeAssistantHistory((prev) =>
            [historyEntry, ...prev].slice(0, 5),
          );
        ...
        const errorResponse = {
          ...
          role: "assistant",
          content:
            "Sorry, I'm having trouble connecting to the AI Mentor. Please try again later.",
        };
      ...
      <div className="code-assistant-grid">
        ...
        <div className="dashboard-card response-card">
          ...
          <div className="card-content response-content">
            ...
            <button
              className="action-btn secondary clear-history-btn"
